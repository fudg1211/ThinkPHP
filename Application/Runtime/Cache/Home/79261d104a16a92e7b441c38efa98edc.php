...
<div class="wrapper">
<form method="POST" id="form" action="./editSave?id=<?php echo ($_GET['id']); ?>">
    <table>
        <tr>
            <td>接口名称：</td>
            <td>
                <input class="input-t" name="name" value="<?php echo ($row['name']); ?>" type="text" maxlength="120" data-validator='{"required":1,"messages":{"required":"请输入接口名称"}}'/>
                <span class="red">*</span>
            </td>
        </tr>
        <tr>
            <td>接口描述：</td>
            <td>
                <textarea class="input-t middle" name="desc" type="text" maxlength="250"><?php echo ($row["desc"]); ?></textarea>
            </td>
        </tr>
        <tr>
            <td class="tr">参数：</td>
        ...
        <tr>
            <td class="tr">返回：</td>
            <td>
                <textarea class="input-t middle" name="result" type="text" style="height: 200px;"  data-validator='{"required":1,"messages":{"required":"请输入放回内容"}}'><?php echo ($row["result"]); ?></textarea>
                <span class="red">*</span>
            </td>
        </tr>
        <tr>
            <td></td>
            <td>
                <input type="button" id="submitButton" class="orangeButton" value=" 更 新 "/>
